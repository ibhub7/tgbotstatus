...
from database import get_user_bots, get_user_config, bots_col # Added bots_col for stats
...
# 2. SECURE DASHBOARD (Requires Key)
...
# 3. SECURE STATS API (Requires Key)
@router.get("/api/stats")
async def get_web_stats(key: str = None):
    """Stats API - Locked with Key"""
    if key != Config.WEB_ACCESS_KEY:
